      ...
      <div className="sticky top-0 h-screen overflow-hidden flex flex-col pt-16 md:pt-20 pb-10 [perspective:1000px] [transform-style:preserve-3d]">
        ...
        <div className="container-wide relative w-full z-10">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            ...
            <a
              className="self-start md:self-auto inline-flex items-center gap-3 font-display font-bold text-sm tracking-[0.18em] uppercase text-white border border-white/15 px-7 py-4 rounded-full hover:border-red-brand hover:text-red-brand transition-all duration-300 group flex-shrink-0"
              href="/projects"
            >
              See All Projects
