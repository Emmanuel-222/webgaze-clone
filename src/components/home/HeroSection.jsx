  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden bg-[#111111] text-[#fafafa]">
      ...
      >
        ...
        />
        <path
          d="M 170 400 A 30 30 0 0 1 230 400"
          fill="none"
          stroke="#ffffff"
          strokeWidth="1.2"
        />
        <path
          d="M 145 400 A 55 55 0 0 1 255 400"
          fill="none"
          stroke="#ffffff"
          strokeWidth="1.2"
        />
        <path
          d="M 120 400 A 80 80 0 0 1 280 400"
          fill="none"
          stroke="#ffffff"
          strokeWidth="1.2"
        />
        <path
          d="M 95 400 A 105 105 0 0 1 305 400"
          fill="none"
          stroke="#ffffff"
          strokeWidth="1.2"
        />
        <path
          d="M 70 400 A 130 130 0 0 1 330 400"
          fill="none"
          stroke="#ffffff"
          strokeWidth="1.2"
        />
        <path
          d="M 45 400 A 155 155 0 0 1 355 400"
          fill="none"
          stroke="#ffffff"
          strokeWidth="1.2"
        />
        <path
          d="M 20 400 A 180 180 0 0 1 380 400"
          fill="none"
          stroke="#ffffff"
          strokeWidth="1.2"
        />
        <path
          d="M 170 600 A 30 30 0 0 0 230 600"
          fill="none"
          stroke="#ffffff"
          strokeWidth="1.2"
        />
        <path
          d="M 145 600 A 55 55 0 0 0 255 600"
          fill="none"
          stroke="#ffffff"
          strokeWidth="1.2"
        />
        <path
          d="M 120 600 A 80 80 0 0 0 280 600"
          fill="none"
          stroke="#ffffff"
          strokeWidth="1.2"
        />
        <path
          d="M 95 600 A 105 105 0 0 0 305 600"
          fill="none"
          stroke="#ffffff"
          strokeWidth="1.2"
        />
        <path
          d="M 70 600 A 130 130 0 0 0 330 600"
          fill="none"
          stroke="#ffffff"
          strokeWidth="1.2"
        />
        <path
          d="M 45 600 A 155 155 0 0 0 355 600"
          fill="none"
          stroke="#ffffff"
          strokeWidth="1.2"
        />
        <path
          d="M 20 600 A 180 180 0 0 0 380 600"
          fill="none"
          stroke="#ffffff"
          strokeWidth="1.2"
        />
        <path
          d="M -5 600 A 205 205 0 0 0 405 600"
          fill="none"
          stroke="#ffffff"
          strokeWidth="1.2"
        />
        ...
        />
        <path
          d="M 200 200 L 400 200 A 200 200 0 0 1 200 400 Z"
          fill="#E01B24"
          opacity="0.18"
        />
        <path
          d="M 0 400 L 200 400 A 200 200 0 0 0 0 600 Z"
          fill="#ffffff"
          opacity="0.16"
        />
      </svg>
