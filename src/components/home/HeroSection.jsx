...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden bg-dark-bg text-[#fafafa]">
      <div
        className="hero-stagger absolute left-0 top-0 h-full w-auto max-w-[60%] sm:max-w-[55%] pointer-events-none select-none opacity-[0.010]"
      ...
      <div className="container-wide w-full relative z-10 flex-1 flex flex-col justify-center items-end text-right pt-28 sm:pt-32 pb-10 sm:pb-12 overflow-hidden">
        <h1
        ...
        <p className="hero-stagger mt-6 font-display font-semibold tracking-[-0.015em] text-white/70 text-[clamp(1.3rem,2.8vw,2.8rem)]" style={{ animationDelay: "300ms" }}>
          Designed to{" "}
          <span style={{ fontWeight: 700, color: "#E01B24" }}>{typedText}</span>
          <span className="animate-blink font-normal" style={{ color: "#E01B24" }}>|</span>
        </p>
